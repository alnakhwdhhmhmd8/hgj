...
import config
from VeGaXMusic.core.mongo import mongodb
...
# التحول إلى الذاكرة [المونجو يمتص في كثير من الأحيان]
loop = {}
playtype = {}
playmode = {}
channelconnect = {}
...
# نوع تحكم سواء للمسؤولين فقط أو للجميع
...
# وضع التشغيل سواء كان استعلامًا مباشرًا أو مضمنًا
