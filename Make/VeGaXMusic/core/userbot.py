...
class Userbot(Client):
    ...
    async def start(self):
        ...
        if config.STRING1:
            ...
            try:
                await self.one.join_chat("VeGaXOne")
                await self.one.join_chat("VeGaDev")
                await self.one.join_chat("VeGaSuport")
                await self.one.join_chat("L_OGO3D")
            except:
                pass
            assistants.append(1)
        ...
        if config.STRING2:
            ...
            try:
                await self.two.join_chat("VeGaXOne")
                await self.two.join_chat("CEOVEGA")
                await self.two.join_chat("G_VaGa")
                await self.two.join_chat("Attackszero")
            except:
                pass
            assistants.append(2)
            try:
        ...
        if config.STRING3:
            ...
            try:
                await self.three.join_chat("VeGaXOne")
                await self.three.join_chat("VeGaXOne")
                await self.three.join_chat("VeGaXOne")
                await self.three.join_chat("VeGaXOne")
            except:
        ...
        if config.STRING4:
            ...
            try:
                await self.four.join_chat("VeGaXOne")
                await self.four.join_chat("VeGaXOne")
                await self.four.join_chat("VeGaXOne")
                await self.four.join_chat("VeGaXOne")
            except:
        ...
        if config.STRING5:
            ...
            try:
                await self.five.join_chat("VeGaXOne")
                await self.five.join_chat("VeGaDev")
                await self.five.join_chat("VeGaXOne")
                await self.five.join_chat("VeGaXOne")
            except:
                pass
