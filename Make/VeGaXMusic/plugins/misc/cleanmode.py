...
from VeGaXMusic.utils.cleanmode import protected_messages
...
@app.on_message( filters.command(["شيير"], "") & SUDOERS, group=6136)
...
@app.on_message(filters.command(["شيرر"], "") & SUDOERS, group=8890)  
...
__MODULE__ = "G-ᴄᴀsᴛ"
__HELP__ = """
<b><blockquote>اوامر تحكم لمالك ومنشئين الأساسيين:</b></blockquote>
</blockquote>
╮❖  تغير اسم الجروب 
│᚜❖ تغير بايو الجروب
│᚜❖ تغير صوره الجروب
