...
from VeGaXMusic.utils.inline.playlist import (
    botplaylist_markup,
    failed_top_markup,
    top_play_markup,
)
...
@app.on_callback_query(filters.regex("get_playmarkup") & ~BANNED_USERS, group=122143)
@languageCB
...
@app.on_callback_query(filters.regex("get_top_playlists") & ~BANNED_USERS, group=16543)
@languageCB
...
@app.on_callback_query(filters.regex("SERVERTOP") & ~BANNED_USERS, group=17666009)
@languageCB
