...
from VeGaXMusic.misc import SUDOERS, db
from VeGaXMusic.utils.database.memorydatabase import (
    is_active_chat,
    is_music_playing,
    is_muted,
    is_nonadmin_chat,
...
from VeGaXMusic.utils.formatters import seconds_to_min
...
@app.on_callback_query(filters.regex("ADMIN") & ~BANNED_USERS, group=323109)
@languageCB
