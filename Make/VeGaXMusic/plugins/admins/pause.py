...
from VeGaXMusic.utils.database import is_music_playing, music_off
...
@app.on_message(filters.command(["pause", "cpause"]) & filters.channel)
@app.on_message(filters.command(["وقف","اسكت"],"") & filters.channel)
