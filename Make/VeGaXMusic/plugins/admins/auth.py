...
from VeGaXMusic.utils.database.mongodatabase import (
    delete_authuser,
    get_authuser,
    get_authuser_names,
    save_authuser,
)
from VeGaXMusic.utils.decorators import AdminActual, language
from VeGaXMusic.utils.formatters import int_to_alpha
...
@app.on_message(filters.command(AUTH_COMMAND) & filters.group & ~BANNED_USERS, group=6097656)
@AdminActual
...
@app.on_message(filters.command(UNAUTH_COMMAND) & filters.group & ~BANNED_USERS, group=6867956)
@AdminActual
...
@app.on_message(filters.command(AUTHUSERS_COMMAND) & filters.group & ~BANNED_USERS, group=68756)
@language
