...
from VeGaXMusic.plugins import extra_plugins_enabled
from VeGaXMusic.utils.inline import close_markup
...
@app.on_message(filters.command(["ايقاف","انهاء"],"") & filters.group & ~BANNED_USERS, group=55158835)
