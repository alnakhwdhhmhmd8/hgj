...
from VeGaXMusic.utils.database.mongodatabase import get_served_chats, is_served_user, get_served_chat, get_served_users, get_sudoers, add_served_user
from pyrogram.enums import ChatType, ChatMemberStatus
from pyrogram.enums import ChatMemberStatus, ParseMode
from pyrogram.enums import ChatMembersFilter
from pyrogram.enums import ChatMemberStatus
from VeGaXMusic.utils.inline.stats import (
    back_stats_buttons,
    back_stats_markup,
    get_stats_markup,
...
@app.on_message(filters.command(STATS_COMMAND) & ~BANNED_USERS, group=837)
@language
...
@app.on_message(filters.command(GSTATS_COMMAND) & ~BANNED_USERS, group=773)
@language
...
@app.on_callback_query(filters.regex("GetStatsNow") & ~BANNED_USERS, group=737373)
@languageCB
...
@app.on_callback_query(filters.regex("TopOverall") & ~BANNED_USERS, group=929828238)
@languageCB
...
@app.on_callback_query(filters.regex("bot_stats_sudo"), group=93909)
@languageCB
async def overall_stats(client, CallbackQuery, _):
...
@app.on_callback_query(
    filters.regex(pattern=r"^(TOPMARKUPGET|GETSTATS|GlobalStats)$") & ~BANNED_USERS, group=73737
)
@languageCB
