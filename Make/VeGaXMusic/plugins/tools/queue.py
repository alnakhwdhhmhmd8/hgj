...
from VeGaXMusic.utils import KIMbin, get_channeplayCB, seconds_to_min
from VeGaXMusic.utils.database import get_cmode, is_active_chat, is_music_playing
from VeGaXMusic.utils.decorators.language import language, languageCB
from VeGaXMusic.utils.inline import queue_back_markup, queue_markup
...
@app.on_message(filters.command(QUEUE_COMMAND) & filters.group & ~BANNED_USERS, group=377784)
@language
...
@app.on_callback_query(filters.regex("GetTimer") & ~BANNED_USERS, group=34433)
...
@app.on_callback_query(filters.regex("GetQueued") & ~BANNED_USERS, group=3454490)
@languageCB
...
@app.on_callback_query(filters.regex("queue_back_timer") & ~BANNED_USERS, group=3467)
@languageCB
