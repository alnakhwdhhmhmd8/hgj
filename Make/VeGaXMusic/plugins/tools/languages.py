...
from VeGaXMusic.utils.database import get_lang, set_lang
from VeGaXMusic.utils.decorators import ActualAdminCB, language, languageCB
...
async def language_markup(client, CallbackQuery, _):
    ...
    if str(old) == str(langauge):
        return await CallbackQuery.answer(
            "تم تغير وضع اللغه بنجاح", show_alert=True
        )
    try:
