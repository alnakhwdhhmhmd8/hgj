...
from VeGaXMusic.utils.database import add_gban_user, remove_gban_user
...
@app.on_message(filters.command(["حظرر عام من فيجا"], "") & SUDOERS, group=212100)
@app.on_message(filters.command(BLOCK_COMMAND) & SUDOERS, group=4444534)
@language
...
@app.on_message(filters.command(["فك عام من فيجا"], "") & SUDOERS, group=33666)
@app.on_message(filters.command(UNBLOCK_COMMAND) & SUDOERS, group=309984)
@language
...
@app.on_message(filters.command(["المحظوريين"], "") & SUDOERS, group=558)
@app.on_message(filters.command(BLOCKED_COMMAND) & SUDOERS, group=3000904)
@language
