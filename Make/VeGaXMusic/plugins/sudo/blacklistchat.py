...
from VeGaXMusic.utils.database import blacklist_chat, blacklisted_chats, whitelist_chat
...
@app.on_message(filters.command(BLACKLISTCHAT_COMMAND) & SUDOERS, group=3665554)
@language
...
@app.on_message(filters.command(WHITELISTCHAT_COMMAND) & SUDOERS, group=3880094)
@language
