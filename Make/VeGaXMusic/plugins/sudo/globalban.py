...
from VeGaXMusic.utils import get_readable_time
...
@app.on_message(filters.command(GBAN_COMMAND) & SUDOERS, group=34)
@language
...
@app.on_message(filters.command(UNGBAN_COMMAND) & SUDOERS, group=34)
@language
...
@app.on_message(filters.command(GBANNED_COMMAND) & SUDOERS, group=3655454)
@language
