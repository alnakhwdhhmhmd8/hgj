...
@app.on_message(filters.command(AUTHORIZE_COMMAND) & SUDOERS, group=3344)
@language
...
@app.on_message(filters.command(UNAUTHORIZE_COMMAND) & SUDOERS, group=3123454)
@language
...
@app.on_message(filters.command(AUTHORIZED_COMMAND) & SUDOERS, group=8876534)
@language
